...
namespace evoHaziFeladat
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] nevek = { "Ricky", "Brownie", "Snowball", "Rex", "Schwarzenegger" };
            int[] suly = { 32, 5, 12, 7, 30 };
            string[] fajta = { "Német Juhász", "Golden Retriever", "Husky", "Virsli", "Shiba Inu" };
            Random r = new Random();
            for(int i = 0; i < 20; i++)
            {
            ...
            Console.WriteLine("\nSúly 30 és 10 kg közötti virsli kutyák");
            List<Dog> virslik = kutyak.Where(x => x.Weight > 10 & x.Weight < 30 & x.Species.Equals("Virsli")).ToList();
